...
This demo uses jquery to perform an ajax request for dummy data from http://baconipsum.com. It utilizes a dropdown and checkbox to pass parameter arguments to the bacon ipsum API
